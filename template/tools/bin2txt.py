...
#BIN_FILE_PATH = r"../TSP_RISCV_template/coremark.bin"
BIN_FILE_PATH = r"template\TSP_RISCV_template\app\dhrystone\dhrystone.bin"

# 2. 输出的 txt 文件路径
IRAM_TXT_PATH = r"FPGA/pango_cpu/source/boot.dat"
SRAM_TXT_PATH = r"FPGA/pango_cpu/source/boot.dat"
