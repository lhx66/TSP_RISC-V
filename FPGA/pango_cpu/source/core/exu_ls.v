...
assign ls_addr_o = ls_addr_r;  // 输出原始地址（可能非对齐），由ls_ctrl处理
assign ls_rd_o   = rd_r;
assign ls_load_type_o = load_type_r;

// Store数据的字节使能生成（简化版，由ls_ctrl处理非对齐）
