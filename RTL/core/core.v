...
module TSP_Core(
    ...
    // 1. IFU 取指单元的 AXI4-Lite Slave 接口
    ,input  wire [31:0] s_axi_if_awaddr, input  wire s_axi_if_awvalid, output wire s_axi_if_awready
    ,input  wire [31:0] s_axi_if_wdata,  input  wire [3:0] s_axi_if_wstrb, input  wire s_axi_if_wvalid, output wire s_axi_if_wready
    ,output wire [1:0]  s_axi_if_bresp,  output wire s_axi_if_bvalid,  input  wire s_axi_if_bready
    ,input  wire [31:0] s_axi_if_araddr, input  wire s_axi_if_arvalid, output wire s_axi_if_arready
    ,output wire [31:0] s_axi_if_rdata,  output wire [1:0] s_axi_if_rresp, output wire s_axi_if_rvalid, input  wire s_axi_if_rready

    // 2. LSU 访存单元的 AXI4-Lite Master 接口
    ,output wire [31:0] m_axi_ls_awaddr, output wire m_axi_ls_awvalid, input  wire m_axi_ls_awready
    ,output wire [31:0] m_axi_ls_wdata,  output wire [3:0] m_axi_ls_wstrb, output wire m_axi_ls_wvalid, input  wire m_axi_ls_wready
    ,input  wire [1:0]  m_axi_ls_bresp,  input  wire m_axi_ls_bvalid,  output wire m_axi_ls_bready
    ,output wire [31:0] m_axi_ls_araddr, output wire m_axi_ls_arvalid, input  wire m_axi_ls_arready
    ,input  wire [31:0] m_axi_ls_rdata,  input  wire [1:0] m_axi_ls_rresp, input  wire m_axi_ls_rvalid, output wire m_axi_ls_rready

    // 3. 【新增】DTCM 数据紧耦合内存 直连端口
    ,output wire [31:0] dtcm_addr_o
...
`endif
    ...
    ls_ctrl u_ls_ctrl(
        ...
        .m_axi_awaddr      (m_axi_ls_awaddr), .m_axi_awvalid     (m_axi_ls_awvalid), .m_axi_awready     (m_axi_ls_awready),
        .m_axi_wdata       (m_axi_ls_wdata),  .m_axi_wstrb       (m_axi_ls_wstrb),   .m_axi_wvalid      (m_axi_ls_wvalid), .m_axi_wready      (m_axi_ls_wready),
        .m_axi_bresp       (m_axi_ls_bresp),  .m_axi_bvalid      (m_axi_ls_bvalid),  .m_axi_bready      (m_axi_ls_bready),
        .m_axi_araddr      (m_axi_ls_araddr), .m_axi_arvalid     (m_axi_ls_arvalid), .m_axi_arready     (m_axi_ls_arready),
        .m_axi_rdata       (m_axi_ls_rdata),  .m_axi_rresp       (m_axi_ls_rresp),   .m_axi_rvalid      (m_axi_ls_rvalid), .m_axi_rready      (m_axi_ls_rready),
