...
module PC_control(
    ...
    output pre_pc_taken_rr, //预测结果是跳转还是不跳转
...
REGs_NLNR #(1) pre_pc_taken_reg0 (pre_pc_taken,pre_pc_taken_r,clk);
REGs_NLNR #(1) pre_pc_taken_reg1 (pre_pc_taken_r,pre_pc_taken_rr,clk);  //打两拍供跳转执行模块使用
